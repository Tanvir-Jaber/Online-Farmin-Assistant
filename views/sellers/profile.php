                                        ...
                                        <form action="../process/data-process.php" method="post">
                                            <div class="card-body">
                                                ...
                                                <p class="text-muted">
                                                    ...
                                                    <input name="email" value="<?php echo $Seemail?>">
                                                </p>
                                                <hr>
                                                ...
                                                <button style="color: black" class="btn btn-success  btn-outline-secondary " name="change_sellers_profile" >Update</button>
                                             ...
                                             <form id="UpdatePass" action="../process/data-process.php" method="post" class="form-horizontal">
                                                 <div class="form-group row">
                                                     <div class="col-sm-12 mb-2">
                                                         <input type="hidden" value="<?php echo $Seid?>" name="user_no">
